...
echo "  monoclaw-repair      - Fix common issues (token sync, device pairing)"
echo "  monoclaw-diagnose    - Run comprehensive diagnostics"
echo ""
...
echo ""
echo "If you see 'pairing required' error on dashboard:"
echo "  1. Enter your auth token in the Password field"
echo "  2. If still failing, run: sudo monoclaw-repair"
echo "     (This auto-approves pending device pairing requests)"
echo ""
echo "If OpenClaw dashboard is not accessible:"
echo "  1. Run diagnostics: sudo monoclaw-diagnose"
echo "  2. Check if port is listening: ss -tlnp | grep 18789"
echo "  3. View service logs: journalctl -u openclaw -n 50"
